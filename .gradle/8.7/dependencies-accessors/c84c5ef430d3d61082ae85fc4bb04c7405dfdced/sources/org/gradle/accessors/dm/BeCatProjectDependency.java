...
@NonNullApi
public class BeCatProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BeCatProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
